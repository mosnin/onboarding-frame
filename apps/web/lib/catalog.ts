...
export const catalog: PatternEntry[] = [
  {
    ...
    name: "Setup wizard",
    tagline:
      "The first-run flow that decides whether someone ever reaches value.",
    description:
    ...
    variants: [
      {
        ...
        blurb:
          "Dark canvas, accent progress rail, poster and spec cards, gated pill CTA.",
      },
      {
        id: "neon-quiz",
        name: "Neon quiz",
        blurb:
          "Black canvas, top-edge accent bar, step counter, corner checks and an optional media panel.",
      },
      {
        id: "warm-survey",
        name: "Warm survey",
        blurb:
          "Soft canvas, dot pagination, icon list rows, welcome and interstitial screens.",
      },
      {
        id: "split-rail",
        name: "Guided split rail",
        blurb:
          "Breadcrumb header with a side panel that reflects state as it is collected.",
      },
      {
        id: "conversational",
        name: "Conversational",
        blurb:
          "Assistant orb, first-person copy, chip sentences and a circular CTA.",
      },
    ],
  },
  {
    ...
    variants: [
      {
        id: "dashboard-card",
        name: "Dashboard card",
        blurb: "Sits inside the product home alongside the first real data.",
      },
      {
        id: "launcher-popover",
        name: "Launcher popover",
        blurb: "Corner launcher with a progress ring that opens the full list.",
      },
      {
        id: "sidebar-panel",
        name: "Sidebar panel",
        blurb: "Docked panel for products where setup is a sustained task.",
      },
      {
        id: "top-banner",
        name: "Top banner",
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        ...
        name: "Beacon",
        blurb:
          "Pulsing hotspots that invite discovery without blocking the UI.",
      },
      {
        id: "modal-sequence",
        name: "Modal sequence",
      ...
      },
      {
        ...
        blurb:
          "Vertical stepper where only the active item expands, beside a recolouring media panel.",
      },
    ],
  },
  {
    ...
    variants: [
      {
        id: "illustration",
        name: "Illustration",
        blurb: "Glyph, copy and a clear primary action.",
      },
      {
        id: "ghost-preview",
        name: "Ghost preview",
    ...
    variants: [
      {
        ...
        blurb:
          "Value comparison, plan picker and split checkout on a mesh canvas.",
      },
      {
        id: "quiet-tiers",
        name: "Quiet tiers",
        blurb:
          "Neutral equal-height cards, inheritance lead-ins and a free escape hatch.",
      },
      {
        id: "trial-timeline",
        name: "Trial timeline",
