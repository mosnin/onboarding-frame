...
const API_LINKS: {
  ...
  {
    id: "quickstart",
    label: "Quickstart: call your first model",
    Glyph: FileIcon,
    tone: "#eef2fb",
    ink: "#5b7cc2",
  },
  {
    id: "sdk",
    label: "Use the SDK (JS, Python, cURL)",
    Glyph: FileIcon,
    tone: "#eef2fb",
    ink: "#5b7cc2",
  },
...
const MODELS = [
  {
    id: "m1",
    org: "northwind",
    name: "motion-2.0/image-to-video",
    desc: "Our most advanced image-to-video model. Animate still images into cinemat…",
  },
  {
    id: "m2",
    org: "",
    name: "prism-2/turbo",
    desc: "Generate high-fidelity images from text in seconds with Prism 2 Turbo, the speed-opti…",
  },
  {
    id: "m3",
    org: "lumaworks",
    name: "swift-horse/v1.1/image-to-video",
    desc: "Swift Horse 1.1 is the top-ranked video model. This image-to-video endpoint ani…",
  },
];
      ...
      <Shell className={cn("flex-col", className)}>
        ...
        */}
          <div className="hidden items-center rounded-[6px] border border-[color:var(--ob-border-strong)] sm:flex">
            <button
              type="button"
              className="px-[10px] py-[5px] text-[0.696rem] font-semibold"
            >
              Docs
            </button>
              ...
              <div className="border-b border-[color:var(--ob-border)] px-[19px] py-[23px] sm:px-[32px]">
                <div className="flex flex-wrap items-end gap-[13px]">
                  <div className="min-w-[0px] flex-1">
                    <h1 className="text-[1.618rem] font-extrabold tracking-tight">
                      Dashboard
                    </h1>
                    <p className="mt-[3px] text-[color:var(--ob-muted)]">
                      ...
                      <button
                        type="button"
                        className="hover:text-[color:var(--ob-fg)]"
                      >
              ...
              <div className="grid gap-[32px] px-[19px] py-[26px] sm:px-[32px]">
                    ...
                    <div className="flex min-w-[0px] flex-col gap-[16px] p-[19px]">
                      <div>
                        ...
                        <p className="mt-[3px] text-[0.744rem] text-[color:var(--ob-muted)]">
                          Let&apos;s get your account ready to generate content
                          or call the API.
                        </p>
                      </div>
                      <ul className="mt-auto grid gap-[10px]">
                        {SETUP.map((item) => (
                          ...
                          >
                            ...
                            {item.action && (
                              <Btn
                                tone={item.primary ? "dark" : "neutral"}
                                size="sm"
                              >
                                {item.icon && (
                                  <Icon
                    ...
                    <div className="flex min-w-[0px] flex-col gap-[13px] p-[19px]">
                      ...
                      <div className="flex items-center gap-[10px] rounded-[6px] border border-[color:var(--ob-border)] p-[8px]">
                        <AlertIcon
                          width={12}
                          height={12}
                          className="shrink-0 text-[#d99b22]"
                        />
                      ...
                      <ul className="grid min-w-[0px] gap-[10px]">
                        {MODELS.map((model) => (
                          <li
                            key={model.id}
                            className="flex min-w-[0px] gap-[10px]"
                          >
                            <span
                              aria-hidden
                      ...
                      <div className="flex items-center gap-[10px]">
                        ...
                        />
                        <span className="text-[0.793rem] font-semibold">
                          Explore all models
                        </span>
                      </div>
                    </div>
                ...
                <div className="grid min-w-[0px] divide-y divide-[color:var(--ob-border)] rounded-[var(--ob-radius)] border border-[color:var(--ob-border)] lg:grid-cols-3 lg:divide-x lg:divide-y-0">
                  ...
                  {[
                    ...
                    {
                      id: "errors",
                      label: "Errors in the last 7 days",
                      color: "#e8365d",
                    },
                  ].map((strip) => (
                    <div
