...
const SUGGESTIONS: {
...
}[] = [
  {
    ...
    logos: ["slack", "notion", "googledrive"],
  },
        ...
        <Sidebar width={199} bg="#f2eeeb" className="border-r-[color:#e4e0dd]">
          ...
          <div className="mt-auto grid gap-3 p-4">
            ...
            >
              ...
              <span
                aria-hidden
                className="size-1.5 rounded-full bg-[#0f8f6f]"
              />
            </button>
            ...
            <div className="rounded-[18px] border border-[color:var(--ob-border)] bg-[color:var(--ob-surface)] p-4 [box-shadow:var(--ob-shadow)]">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="ml-auto flex items-center gap-3">
                  <button
                    type="button"
                    className="flex items-center gap-1 text-[0.88rem] text-[color:var(--ob-muted)]"
                  >
                    Model{" "}
                    <ChevronDown
                      width={13}
