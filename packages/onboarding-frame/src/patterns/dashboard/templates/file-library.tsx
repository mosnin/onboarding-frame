    ...
    <Surface tokens={fileLibraryTokens}>
      <Shell className={cn(className)} bg="#fcfbfe">
        ...
        <Sidebar width={255} bg="var(--ob-surface-2)" className="border-r-0">
          ...
          <p className="px-[18px] pb-[4px] pt-[21px] text-[0.726rem] text-[color:var(--ob-muted)]">
            Projects
          </p>
          <nav className="grid gap-[2px] px-[11px]">
            {PROJECTS.map((item) => (
              ...
              >
                ...
                {item.badge && (
                  <span className="text-[0.726rem] text-[color:var(--ob-muted)]">
                    {item.badge}
                  </span>
                )}
              </button>
        ...
        <Main className="p-[14px]">
          <div className="flex flex-1 flex-col rounded-[12px] border border-[color:var(--ob-border)] bg-[color:var(--ob-surface)] p-[21px] sm:p-[28px]">
            <div className="flex flex-wrap items-center gap-[14px]">
              <h1 className="text-[1.3rem] font-extrabold tracking-tight">
                My files
              </h1>
              <Segmented
                items={[
              ...
              <div className="ml-auto flex items-center gap-[9px]">
                ...
                <div className="flex items-center rounded-[7px] border border-[color:var(--ob-border)]">
                  ...
                  <button
                    ...
                    className="px-[9px] py-[5px] opacity-50"
                  >
                ...
                <Btn
                  tone="primary"
                  size="sm"
                  className="bg-[#1b6b4a] text-white"
                >
                  New file
                  <span className="flex items-center gap-[4px]">
                    <kbd className="rounded bg-white/20 px-[4px] text-[0.619rem]">
                      ⌘
                    </kbd>
                    <kbd className="rounded bg-white/20 px-[4px] text-[0.619rem]">
                      N
            ...
            <div className="mt-[28px] grid gap-x-[18px] gap-y-[28px] sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <p className="mt-[11px] font-semibold text-[#1b6b4a]">
                  Create a new design
                </p>
              </div>
