...
const TASKS = [
  {
    ...
    mins: "2 mins",
    body: "Pick a plan that fits your workflow and business goals.",
  },
  {
    id: "services",
    title: "Add your services",
    mins: "1 min",
    body: "List your offerings to use in proposals and bookings.",
  },
  {
    id: "types",
    title: "Customise project types",
    mins: "2 mins",
    body: "Define the types of work you manage for better organisation.",
  },
  {
    id: "pipeline",
    title: "Customise your pipeline",
    mins: "3 mins",
    body: "Tailor your workflow stages to match how you move clients from enquiry to delivery.",
  },
  {
    id: "form",
    title: "Publish a lead form",
    mins: "2 mins",
    body: "Start capturing new enquiries directly into your workspace.",
  },
  {
    id: "project",
    title: "Create your first project",
    mins: "3 mins",
    body: "Set up a workspace for an upcoming or sample project to see how everything connects.",
  },
  {
    id: "contact",
    title: "Add your first contact",
    mins: "1 min",
    body: "Add a client or lead to begin tracking communication and bookings.",
  },
];
        ...
        <div className="flex flex-1">
          ...
          <Sidebar width={240} bg="#121416" className="border-r-0 text-white">
            ...
            <div className="mx-3 rounded-[10px] border border-white/15 p-3.5">
              ...
              <p className="mt-2 text-[0.82rem] text-white/60">
                {done}/7 completed
              </p>
            </div>
          ...
          <Main className="relative">
            <TopBar border={false} className="gap-4">
              ...
              <div className="ml-auto flex items-center gap-4">
                <button
                  type="button"
                  className="flex items-center gap-1.5 text-[0.9rem] font-semibold text-[#5b4bd6]"
                >
                ...
                <div className="grid content-start gap-5">
                  <Card className="p-0">
                    ...
                    <div className="flex items-center gap-3 border-t border-[color:var(--ob-border)] p-5">
                      ...
                      <span
                        aria-hidden
                        className="size-11 rounded-full bg-[#1170b8]"
                      />
            ...
            {[
              {
                ...
                blurb:
                  "Connect your bank accounts to view your accounts balance.",
              },
              {
                id: "cards",
              ...
              >
                ...
                <p className="pt-2 text-[1.9rem] font-extrabold tabular-nums">
                  $0
                </p>
    ...
    <div>
      <p className="flex items-center gap-2 text-[0.95rem]">
        {dash ? (
          <span
            aria-hidden
            className="h-[2px] w-4 shrink-0 bg-[color:var(--ob-fg)]"
          />
        ) : (
          <span
            aria-hidden
